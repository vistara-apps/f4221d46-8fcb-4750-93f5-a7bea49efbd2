    ...
    <div className="space-y-6">
      ...
      <div className="glass-card p-6 rounded-lg">
        ...
        <div className="flex items-end space-x-4">
          ...
          <div
            className={`flex items-center space-x-1 ${getChangeColor(metrics.totalChangePercent24h)}`}
          >
        ...
        <p className="text-gray-300 text-sm mt-1">
          {formatPercentage(metrics.totalChangePercent24h)} (
          {formatCurrency(metrics.totalChange24h)}) today
        </p>
      </div>
      ...
      <div className="glass-card p-6 rounded-lg">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex space-x-2">
            ...
            <button className="text-xs px-3 py-1 text-gray-400 hover:text-white transition-colors duration-200">
              7D
            </button>
            <button className="text-xs px-3 py-1 text-gray-400 hover:text-white transition-colors duration-200">
              30D
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="metric-card">
          ...
          <p
            className={`text-2xl font-bold ${getChangeColor(metrics.totalChangePercent24h)}`}
          >
            {formatPercentage(metrics.totalChangePercent24h)}
          </p>
